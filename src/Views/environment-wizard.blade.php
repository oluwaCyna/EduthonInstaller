                ...
                <div class="block margin-bottom-2">
                    ...
                    <div class="info">
                        <div class="form-group {{ $errors->has('pusher_app_id') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="pusher_app_id" id="pusher_app_id" value="{{ old('owner_fname') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.pusher_app_id_palceholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('pusher_app_key') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="pusher_app_key" id="pusher_app_key" value="{{ old('owner_fname') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.pusher_app_key_palceholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('pusher_app_secret') ? ' has-error ' : '' }}">
                            ...
                            <input type="password" name="pusher_app_secret" id="pusher_app_secret" value="{{ old('owner_fname') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.pusher_app_secret_palceholder') }}" />
